...
//		 }
		...
		// Dump Format------------------
		 av_dump_format(ofmt_ctx, 0, out_filename, 1);
//		 System.err.println("尝试打开输入文件");
		/* open the output file, if needed */
//		if(avio_open2(ifmt_ctx.pb(), in_filename, AVIO_FLAG_READ_WRITE, null, null) < 0) {
//			 System.err.println("打开输入流失败");
//			return false;
//		}
//		 System.err.println("已经打开了输入流");
		 //打开输出URL（Open output URL）
//		 System.err.println("尝试打开输出流");
...
//			 return false;
//		 }
		 System.err.println("已经打开输出流");
		//
		// 写文件头（Write file header）
//		AVDictionary metadata = new AVDictionary(null);
		/* write the stream header, if any */
		System.err.println("写入头");
//		AVDictionary options = new AVDictionary(null);
		if (avformat_write_header(ofmt_ctx, (PointerPointer<?>) null) < 0) {
			return false;
		}
		System.err.println("写入头完成");
		AVStream in_stream;
		try {
