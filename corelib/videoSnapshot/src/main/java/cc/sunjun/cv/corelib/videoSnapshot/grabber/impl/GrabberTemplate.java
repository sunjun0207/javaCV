...
public abstract class GrabberTemplate {
	 ...
	 * @throws IOException
	 */
	public ByteBuffer grabVideoFrame(String url, int fmt){
...
//		}
		...
		SwsContext sws_ctx = sws_getContext(width, height, pCodecCtx.pix_fmt(), width, height, fmt, SWS_FAST_BILINEAR,
				null, null, param);
